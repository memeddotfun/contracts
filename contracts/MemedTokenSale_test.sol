...
contract MemedTokenSale_test is Ownable, ReentrancyGuard {
    ...
    function commitToFairLaunch(
        ...
        uint256 useAmount = amount > capLeft ? capLeft : amount;
        ...
        uint256 refundAmount = amount > useAmount ? amount - useAmount : 0;
        if (refundAmount > 0) IERC20(MEMED_TEST_ETH).transfer(msg.sender, refundAmount);
